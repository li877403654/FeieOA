	...
	<div id="MainArea">
		<table cellspacing="0" cellpadding="0" class="TableStyle">
			...
			<tbody id="TableData">
				<tr class="TableDetail1 template">
					...
					<th>${department.uname}&nbsp;</th>
					<th><a onClick="return window.confirm('这将删除所有的下级部门，您确定要删除吗？')"
						href="dept_del.action?did=${department.did }">删除</a> <a href="dept_getUname.action?did=${department.did }&go=1">修改</a></th>
				</tr>
				</c:forEach>
			</tbody>
		</table>
		...
		<div id="TableTail">
			<div id="TableTail_inside">
				<a href="dept_getUname.action?dpid=${dpid}&go=2" target="right"><img
					src="${pageContext.request.contextPath}/style/images/createNew.png" /></a>
				<a href="#" onclick="JavaScript:history.back(-1);" target="right"><img
