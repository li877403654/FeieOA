...
<script language="javascript" src="${pageContext.request.contextPath}/script/jquery.js"></script>
    ...
    function gotoPageNum(num,uid){
    	...
    	location.href ="email_box.action?uid="+uid+"&startnum="+num+"&box=inbox";
    }
    function goNum(uid){
    	var a = $(".inputStyle").val();
    	//alert("email_box.action?uid="+uid+"&startnum="+a+"&box=waste");
    	location.href ="email_box.action?uid="+uid+"&startnum="+a+"&box=inbox";
    }
    </script>
</head>
<body>
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 收件箱
        </div>
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <c:forEach items="${email }" var="email">
        	 <tr  align=center class="TableDetail1 template">
                ...
                <td><a href="email_reply.action?goid=${email.goid }">回复</a>
					<a onClick="return delConfirm()" href="email_del.action?eid=${email.eid }&box=inbox">删除</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<div id=PageSelectorBar>
	...
	<div id=PageSelectorSelectorArea>
		...
		-->
		<a href="email_box.action?uid=${user.uid}&startnum=1&box=inbox" title="首页" style="cursor: hand;">
		...
		-->
		<a href="email_box.action?uid=${user.uid}&startnum=${sumnum}&box=inbox" title="尾页" style="cursor: hand;"><img src="${pageContext.request.contextPath}/style/blue/images/pageSelector/lastPage.png"/></a>
