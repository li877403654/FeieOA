...
<script language="javascript" src="${pageContext.request.contextPath}/script/jquery.js"></script>
    ...
    function gotoPageNum(num,uid){
    	...
    	location.href ="email_box.action?uid="+uid+"&startnum="+num+"&box=outbox";
    }
    function goNum(uid){
    	var a = $(".inputStyle").val();
    	//alert("email_box.action?uid="+uid+"&startnum="+a+"&box=waste");
    	location.href ="email_box.action?uid="+uid+"&startnum="+a+"&box=outbox";
    }
    </script>
</head>
<body>
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 发件箱
        </div>
        ...
        <tbody id="TableData">
            <c:forEach items="${email }" var="email">
        	 <tr  align=center class="TableDetail1 template">
                ...
                <td><a href="email_newout.action?eid=${email.eid }">重新发送 </a>
                </td>
            </tr>
            </c:forEach>
        </tbody>
...
<div id=PageSelectorBar>
	...
	<div id=PageSelectorSelectorArea>
		...
		-->
		<a href="email_box.action?uid=${user.uid}&startnum=1&box=outbox" title="首页" style="cursor: hand;">
		...
		-->
		<a href="email_box.action?uid=${user.uid}&startnum=${sumnum }&box=outbox" title="尾页" style="cursor: hand;"><img src="${pageContext.request.contextPath}/style/blue/images/pageSelector/lastPage.png"/></a>
